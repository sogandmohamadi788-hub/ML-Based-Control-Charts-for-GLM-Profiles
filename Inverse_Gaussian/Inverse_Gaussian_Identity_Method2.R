...
# Generating in-control data with no shifts

set.seed(10)

# Generating data using the Inverse Gaussian GLM profile function defined above

x_NN_in=invgaussi_identity(n=9,number_iter=1350)
...
# Generating out-of-control data with different shift levels

set.seed(11)

# Generating data with shift0 equal to 0.1

x_NN_out_shif0a=invgaussi_identity(n=9,shift0=0.1,shift1=0,number_iter=150)
set.seed(12)

# Generating data with shift1 equal to 0.1

x_NN_out_shif1a=invgaussi_identity(n=9,shift0=0,shift1=0.1,number_iter=150)
set.seed(13)

# Generating data with shift0 and shift1 equal to 0.1

x_NN_out_botha=invgaussi_identity(n=9,shift0=0.1,shift1=0.1,number_iter=150)

set.seed(14)

# Generating data with shift0 equal to 0.5

x_NN_out_shif0b=invgaussi_identity(n=9,shift0=0.5,shift1=0,number_iter=150)
set.seed(15)

# Generating data with shift1 equal to 0.5

x_NN_out_shif1b=invgaussi_identity(n=9,shift0=0,shift1=0.5,number_iter=150)
set.seed(16)

# Generating data with shift0 and shift1 equal to 0.5

x_NN_out_bothb=invgaussi_identity(n=9,shift0=0.5,shift1=0.5,number_iter=150)

set.seed(17)

# Generating data with shift0 equal to 1

x_NN_out_shif0c=invgaussi_identity(n=9,shift0=1,shift1=0,number_iter=150)
set.seed(18)

# Generating data with shift1 equal to 1

x_NN_out_shif1c=invgaussi_identity(n=9,shift0=0,shift1=1,number_iter=150)
set.seed(19)

# Generating data with shift0 and shift1 equal to 1

x_NN_out_bothc=invgaussi_identity(n=9,shift0=1,shift1=1,number_iter=150)
